...
\begin{frame}
  ...
  \begin{array}[t]{lcll}
    \mathrm{fastexp}\; r\; b\; 0&=& r &\\
    \mathrm{fastexp}\; r\; b\; n&=&
    \mathrm{fastexp}\; r\; (b^2)\; \lfloor n/2\rfloor
    &\mathrm{if}\;n\;\mathrm{even}\\
    \mathrm{fastexp}\; r\; b\; n&=&
    \mathrm{fastexp}\; (r\cdot b)\; (b^2)\; \lfloor n/2\rfloor
    &\mathrm{otherwise}
  \end{array}\medskip
...
For example:
  ...
  \begin{array}[t]{l@{\qquad\qquad}c}
    \mathrm{fastexp}\;1\;b\;6 = &\mathbf{EVEN}\\
    \mathrm{fastexp}\;1\;(b^2)\;3 =&\mathbf{ODD}\\
    \mathrm{fastexp}\;(1\cdot b^2)\;({b^2}^2)\;1 =&\mathbf{ODD}\\
    \mathrm{fastexp}\;(1\cdot b^2\cdot {b^2}^2)\;({{b^2}^2}^2)\;0 =&\mathbf{ZERO}\\
